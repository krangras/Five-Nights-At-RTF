...
Ты — ночной охранник. С **0:00** до **6:00** тебе нужно:

- **Следить за камерами** через планшет — 7 комнат + 4 вент-камеры
- **Взламывать сервер** через ноутбук — автопрогресс, но привлекает Алгема
...
Если Алгем до тебя добрался — **game over**. Дожил до 6 утра — **победа**.
...
<p align="center">
  <i>Переживи ночь. Не дай Алгему зайти.</i>
</p>
