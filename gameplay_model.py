...
# Конфиг ночей для AlgemAI (передаётся через объект AI)
NIGHT_CONFIG: dict[int, dict] = {
    1: {"move_lo": 480, "move_hi": 720},
    2: {"move_lo": 360, "move_hi": 600},
    3: {"move_lo": 300, "move_hi": 480},
    4: {"move_lo": 180, "move_hi": 360},
    5: {"move_lo": 120, "move_hi": 240},
}
