...
Запуск:  python -m pytest tests/test_algem_talk_integration.py -v
          python tests/test_algem_talk_integration.py
"""
...
from gameplay_model import GameModel, BASE_GRAPH
