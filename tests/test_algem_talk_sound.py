...
Запуск:  python -m pytest tests/test_algem_talk_sound.py -v
"""
...
def test_office_distances() -> None:
    assert OFFICE_DISTANCES == {1: 4, 2: 4, 3: 3, 4: 3, 5: 2, 6: 3, 7: 1}
...
@pytest.mark.parametrize("algem_node,expected", [
    (1, {1: 0, 2: 1, 3: 1, 4: 2, 5: 2, 6: 3, 7: 3}),
    (3, {1: 1, 2: 1, 3: 0, 4: 1, 5: 1, 6: 2, 7: 2}),
    (7, {1: 3, 2: 3, 3: 2, 4: 2, 5: 1, 6: 2, 7: 0}),
])
