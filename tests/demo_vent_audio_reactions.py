...
Run:
    python tests/demo_vent_audio_reactions.py
...
from gameplay_model import CAMERAS, GameModel, SealState
...
def _load_window_icon() -> pygame.Surface | None:
    icon_path = Path(__file__).resolve().parent.parent / "assets" / "logo" / "logo_32_rgb.png"
